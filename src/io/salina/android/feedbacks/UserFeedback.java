...
public class UserFeedback {
	...
	/*package*/ static class Feedback {		
		...
		/**
		 * 피드백의 카테고리 정보 <br>
		 * 질문 카테고리 : {@link UserFeedback#CATEGORY_QUESTION}, <br>
		 * 제안 카테고리 : {@link UserFeedback#CATEGORY_SUGGESTION}, <br>
		 * 문제 카테고리 : {@link UserFeedback#CATEGORY_PROBLEM}, <br>
		 * 평가 카테고리 : {@link UserFeedback#CATEGORY_EVALUATION} <br>
		 */
